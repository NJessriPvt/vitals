...
async function detectedActivities(fromMs, toMs, profile) {
  ...
  return {
    ...
    limitation: 'Heart-rate only: activity type needs movement or GPS data and is not guessed. Calories are apportioned from overlapping active-energy records.',
  };
}
