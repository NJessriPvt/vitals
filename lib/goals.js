...
function buildAdaptiveGoals({
  ...
  return {
    ...
    adapted: lowDay,
    derived: true,
    method: 'Move and steps are your own 28-day medians (bounded), ×0.8 on readiness under 45; Train is the WHO 150 weekly zone minutes split daily, halved on readiness under 45; Recover is tonight’s sleep need.',
  };
}
...
module.exports = { buildAdaptiveGoals, buildRings, buildBadges, longestStreak };
